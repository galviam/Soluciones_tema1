...
```{r}
commonAnimals <- intersect(r_m, r_a)
commonAnimals
...
# En los dos dataframes se guardan animles igual con la diferencia de que no tiene el mismo nombre, es decir, en cada uno de los data frames el mismo animal tiene diferente nombre.
